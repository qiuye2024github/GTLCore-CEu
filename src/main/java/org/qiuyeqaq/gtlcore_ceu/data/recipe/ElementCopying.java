...
import static org.qiuyeqaq.gtlcore_ceu.common.data.GTLCEuRecipeTypes.ELEMENT_COPYING_RECIPES;
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        for (Material e : fes) {
            ...
            ELEMENT_COPYING_RECIPES.recipeBuilder(e.getName())
                    ...
                    .inputFluids(GTMaterials.UUMatter.getFluid(Math.toIntExact(atomic)))
