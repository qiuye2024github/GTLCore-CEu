...
public class GTLCEuCreativeModeTabs {
    ...
    public static RegistryEntry<CreativeModeTab> GTL_CORE_CEU = REGISTRATE
            .defaultCreativeTab(GTLCore_CEu.MOD_ID, builder -> builder
                    .displayItems(new GTCreativeModeTabs.RegistrateDisplayItemsGenerator(GTLCore_CEu.MOD_ID, REGISTRATE))
