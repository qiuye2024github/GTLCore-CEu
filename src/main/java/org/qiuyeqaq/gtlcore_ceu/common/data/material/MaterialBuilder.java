...
public class MaterialBuilder {
    ...
    public static void init() {
        ...
        Bloodstone = new Material.Builder(GTCEu.id("bloodstone"))
                .ore()
                .addOreByproducts(Deepslate, GTMaterials.Redstone)
                .color(0xd80036)
                .iconSet(QUARTZ)
                .buildAndRegister();
        ...
        ConductiveAlloy = new Material.Builder(GTCEu.id("conductive_alloy"))
                ...
                .color(0xf7b29b)
                .iconSet(MAGNETIC)
                .components(Iron, 1, GTMaterials.Redstone, 1)
        ...
        EnergeticAlloy = new Material.Builder(GTCEu.id("energetic_alloy"))
                ...
                .components(Gold, 2, GTMaterials.Redstone, 1, Glowstone, 1)
        ...
        Adamantium = new Material.Builder(GTCEu.id("adamantium"))
                ...
                .element(GTLCEuElements.ADAMANTIUM)
                .color(0xefbe35)
                .iconSet(METALLIC)
        ...
        Quantanium = new Material.Builder(GTCEu.id("quantanium"))
                ...
                .element(GTLCEuElements.QUANTANIUM)
                .color(0x0dff02)
                .iconSet(METALLIC)
        ...
        Vibranium = new Material.Builder(GTCEu.id("vibranium"))
                ...
                .element(GTLCEuElements.VIBRANIUM)
                .color(0xff0000)
                .iconSet(METALLIC)
                .toolStats(ToolProperty.Builder.of(1.0F, 1.0F, 100, 10, GTToolType.DRILL_LV).build())
                .flags(GTLCEuMaterialFlags.GENERATE_NANOSWARM, GENERATE_ROTOR, GENERATE_FRAME)
                .buildAndRegister();
        ...
        Tairitsu = new Material.Builder(GTCEu.id("tairitsu"))
                ...
                .components(Tungsten, 8, Naquadria, 7, Trinium, 4, GTMaterials.Carbon, 4, Vanadium, 3,
                        Plutonium239, 1)
                .iconSet(METALLIC)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        Draconium = new Material.Builder(GTCEu.id("draconium"))
                ...
                .fluid()
                .blastTemp(19200)
                .element(GTLCEuElements.DRACONIUM)
                .color(0xa300cc)
                .iconSet(RADIOACTIVE)
                .flags(GTLCEuMaterialFlags.GENERATE_NANOSWARM, GENERATE_ROTOR, GENERATE_FRAME, NO_SMELTING)
                .buildAndRegister();
        ...
        Hypogen = new Material.Builder(GTCEu.id("hypogen"))
                ...
                .element(GTLCEuElements.HYPogen)
                .iconSet(RADIOACTIVE)
                .flags(GENERATE_PLATE)
        ...
        Shirabon = new Material.Builder(GTCEu.id("shirabon"))
                ...
                .element(GTLCEuElements.SHIRABON)
        ...
        Mithril = new Material.Builder(GTCEu.id("mithril"))
                ...
                .element(GTLCEuElements.MITHRIL)
                .color(0x4da6ff)
                .iconSet(METALLIC)
        ...
        Taranium = new Material.Builder(GTCEu.id("taranium"))
                ...
                .element(GTLCEuElements.TARANIUM)
                .color(0x000033)
                .iconSet(RADIOACTIVE)
        ...
        Crystalmatrix = new Material.Builder(GTCEu.id("crystalmatrix"))
                ...
                .element(GTLCEuElements.CRYSTALMATRIX)
                .color(0x33ffff)
                .iconSet(RADIOACTIVE)
                .flags(GENERATE_SPRING, GENERATE_SPRING_SMALL)
        ...
        CosmicNeutronium = new Material.Builder(GTCEu.id("cosmicneutronium"))
                ...
                .element(GTLCEuElements.COSMICNEUTRONIUM)
                .color(0x000d1a)
                .iconSet(new MaterialIconSet("cosmicneutronium", BRIGHT))
                .flags(GTLCEuMaterialFlags.GENERATE_NANOSWARM, GENERATE_SPRING, GENERATE_FINE_WIRE,
        ...
        Echoite = new Material.Builder(GTCEu.id("echoite"))
                ...
                .element(GTLCEuElements.ECHOITE)
                .color(0x26734d)
                .iconSet(METALLIC)
                .flags(GENERATE_ROD, GENERATE_FINE_WIRE)
                .cableProperties(GTValues.V[GTValues.UIV], 32, 0, true)
                .toolStats(ToolProperty.Builder.of(6.0F, 100.0F, 64, 6, GTLCEuToolType.VAJRA).magnetic()
                        .unbreakable().build())
                .buildAndRegister();
        ...
        Legendarium = new Material.Builder(GTCEu.id("legendarium"))
                ...
                .element(GTLCEuElements.LEGENDARIUM)
                .color(0x00ffff)
                .iconSet(RADIOACTIVE)
                .flags(GENERATE_FINE_WIRE)
        ...
        DraconiumAwakened = new Material.Builder(GTCEu.id("draconiumawakened"))
                ...
                .element(GTLCEuElements.DRACONIUMAWAKENED)
                .color(0xcc6600)
                .iconSet(RADIOACTIVE)
                .flags(GENERATE_FINE_WIRE)
        ...
        Adamantine = new Material.Builder(GTCEu.id("adamantine"))
                ...
                .element(GTLCEuElements.ADAMANTINE)
                .color(0xe6e600)
                .iconSet(METALLIC)
                .flags(GENERATE_FINE_WIRE)
        ...
        Starmetal = new Material.Builder(GTCEu.id("starmetal"))
                ...
                .element(GTLCEuElements.STARMETAL)
                .color(0x0000e6)
                .iconSet(METALLIC)
                .flags(GTLCEuMaterialFlags.GENERATE_NANOSWARM, GENERATE_FINE_WIRE)
        ...
        Orichalcum = new Material.Builder(GTCEu.id("orichalcum"))
                ...
                .element(GTLCEuElements.ORICHALCUM)
                .color(0xff78c9)
                .iconSet(METALLIC)
                .flags(GTLCEuMaterialFlags.GENERATE_NANOSWARM, GENERATE_ROUND, GENERATE_ROTOR, GENERATE_GEAR,
        ...
        Infuscolium = new Material.Builder(GTCEu.id("infuscolium"))
                ...
                .element(GTLCEuElements.INFUSCOLIUM)
                .color(0xff77ff)
                .iconSet(RADIOACTIVE)
                .flags(GTLCEuMaterialFlags.GENERATE_NANOSWARM, GENERATE_ROUND, GENERATE_ROTOR, GENERATE_GEAR,
                        GENERATE_SMALL_GEAR, GENERATE_LONG_ROD)
        ...
        Enderium = new Material.Builder(GTCEu.id("enderium"))
                ...
                .element(GTLCEuElements.ENDERIUM)
                .color(0x75ede2)
                .iconSet(METALLIC)
                .flags(GTLCEuMaterialFlags.GENERATE_NANOSWARM, GENERATE_FINE_WIRE)
                .buildAndRegister();
        ...
        Eternity = new Material.Builder(GTCEu.id("eternity"))
                ...
                .element(GTLCEuElements.ETERNITY)
                .iconSet(new MaterialIconSet("eternity"))
                .flags(GTLCEuMaterialFlags.GENERATE_NANOSWARM, GENERATE_FOIL, GENERATE_FRAME)
                .buildAndRegister();

        Magmatter = new Material.Builder(GTCEu.id("magmatter"))
                .ingot()
                .liquid(new FluidBuilder().customStill())
                .element(GTLCEuElements.MAGMATTER)
        ...
        DegenerateRhenium = new Material.Builder(GTCEu.id("degenerate_rhenium"))
                ...
                .fluid()
                .color(0x4646ff)
                .element(GTLCEuElements.DEGENERATE_REHENIUM)
                .iconSet(RADIOACTIVE)
        ...
        HeavyQuarkDegenerateMatter = new Material.Builder(
                ...
                .element(GTLCEuElements.HEAVY_QUARK_DEGENERATE_MATTER)
        ...
        QuantumChromodynamicallyConfinedMatter = new Material.Builder(
                ...
                .fluid()
                .plasma()
                .element(GTLCEuElements.QUANTUMCHROMODYNAMICALLY_CONFINED_MATTER)
        ...
        TranscendentMetal = new Material.Builder(GTCEu.id("transcendentmetal"))
                .ingot()
                .fluid()
                .element(GTLCEuElements.TRANSCENDENTMETAL)
                .color(0xffffff)
                .iconSet(GTLCEuMaterialIconSet.CUSTOM_TRANSCENDENT_MENTAL)
                .flags(GTLCEuMaterialFlags.GENERATE_NANOSWARM, GENERATE_ROUND, GENERATE_ROTOR, GENERATE_GEAR,
                        GENERATE_SMALL_GEAR, GENERATE_LONG_ROD)
                .buildAndRegister();
        ...
        Uruium = new Material.Builder(GTCEu.id("uruium"))
                ...
                .element(GTLCEuElements.URUIUM)
                .color(0x87ceeb)
                .flags(GTLCEuMaterialFlags.GENERATE_NANOSWARM)
                .iconSet(METALLIC)
        ...
        MagnetohydrodynamicallyConstrainedStarMatter = new Material.Builder(GTCEu.id("magnetohydrodynamicallyconstrainedstarmatter"))
                ...
                .element(GTLCEuElements.RAW_STAR_MATTER)
        ...
        WhiteDwarfMatter = new Material.Builder(GTCEu.id("white_dwarf_mtter"))
                .ingot()
                .fluid()
                .element(GTLCEuElements.STAR_MATTER)
                .color(0xffffff)
                .flags(GTLCEuMaterialFlags.GENERATE_NANOSWARM, GENERATE_FINE_WIRE)
                .iconSet(BRIGHT)
                .buildAndRegister();
        ...
        AstralTitanium = new Material.Builder(GTCEu.id("astraltitanium"))
                ...
                .fluid()
                .plasma()
                .element(GTLCEuElements.ASTRALTITANIUM)
                .color(0xf6cbf6)
                .flags(GENERATE_GEAR)
                .iconSet(BRIGHT)
                .buildAndRegister();
        ...
        CelestialTungsten = new Material.Builder(GTCEu.id("celestialtungsten"))
                ...
                .fluid()
                .plasma()
                .element(GTLCEuElements.CELESTIALTUNGSTEN)
                .color(0x303030)
                .flags(GENERATE_GEAR)
                .iconSet(BRIGHT)
                .buildAndRegister();
        ...
        EglinSteel = new Material.Builder(GTCEu.id("eglin_steel"))
                ...
                .fluid()
                .blastTemp(1048, LOW)
                .components(Iron, 4, Kanthal, 1, Invar, 5, Sulfur, 1, Silicon, 1, GTMaterials.Carbon, 1)
                .color(0x4e270b)
                .iconSet(METALLIC)
        ...
        Lafium = new Material.Builder(GTCEu.id("lafium"))
                ...
                .components(HastelloyN, 8, Naquadah, 4, Samarium, 2, Tungsten, 4,
                        Aluminium, 6, Nickel, 2, GTMaterials.Carbon, 2)
                .color(0x235497)
                .iconSet(METALLIC)
                .flags(GENERATE_PLATE, DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        Grisium = new Material.Builder(GTCEu.id("grisium"))
                ...
                .fluid()
                .blastTemp(4850, HIGH)
                .components(Titanium, 9, GTMaterials.Carbon, 9, Potassium, 9, Lithium, 9, Sulfur, 9,
                        Hydrogen, 5)
                .color(0x355d6a)
                .iconSet(METALLIC)
                .flags(GENERATE_PLATE)
        ...
        SiliconCarbide = new Material.Builder(GTCEu.id("silicon_carbide"))
                ...
                .components(Silicon, 1, GTMaterials.Carbon, 1)
                .color(0x34adb6)
                .iconSet(METALLIC)
                .flags(GENERATE_PLATE)
                .buildAndRegister();
        ...
        ZirconiumCarbide = new Material.Builder(GTCEu.id("zirconium_carbide"))
                ...
                .components(Zirconium, 1, GTMaterials.Carbon, 1)
                .color(0xd2bfaa)
                .iconSet(METALLIC)
                .flags(GENERATE_PLATE)
                .buildAndRegister();
        ...
        ReactorSteel = new Material.Builder(GTCEu.id("reactor_steel"))
                ...
                .components(Iron, 15, Niobium, 1, Vanadium, 4, GTMaterials.Carbon, 2)
                .color(0xb4b3b0)
                .iconSet(SHINY)
        ...
        NotFound = new Material.Builder(GTCEu.id("not_found"))
                .fluid()
                .color(0x1e0ebe)
                .components(Hydrogen, 1, GTMaterials.Carbon, 1, Nitrogen, 1, Oxygen, 1, Fluorine, 1,
        ...
        Polyetheretherketone = new Material.Builder(GTCEu.id("polyetheretherketone"))
                .polymer()
                .fluid()
                .components(GTMaterials.Carbon, 20, Hydrogen, 12, Oxygen, 3)
                .color(0x33334d)
                .iconSet(DULL)
                .flags(GENERATE_FINE_WIRE)
                .buildAndRegister();
        ...
        Zylon = new Material.Builder(GTCEu.id("zylon"))
                .polymer()
                .fluid()
                .components(GTMaterials.Carbon, 14, Hydrogen, 6, Nitrogen, 2, Oxygen, 2)
                .color(0xd2b800)
                .iconSet(DULL)
                .flags(GENERATE_FOIL)
                .buildAndRegister();
        ...
        Radox = new Material.Builder(GTCEu.id("radox"))
                .polymer()
                .fluid()
                .components(GTMaterials.Carbon, 14, Osmium, 11, Oxygen, 7, Silver, 3, Concrete, 1, Water, 1)
                .color(0x680064)
                .iconSet(DULL)
        ...
        PreZylon = new Material.Builder(GTCEu.id("pre_zylon"))
                .dust()
                .color(0x562050)
                .components(GTMaterials.Carbon, 20, Hydrogen, 22, Nitrogen, 2, Oxygen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Terephthalaldehyde = new Material.Builder(GTCEu.id("terephthalaldehyde"))
                .dust()
                .color(0x4a7454)
                .components(GTMaterials.Carbon, 8, Hydrogen, 6, Oxygen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Durene = new Material.Builder(GTCEu.id("durene"))
                .dust()
                .components(GTMaterials.Carbon, 10, Hydrogen, 14)
                .color(0x708090)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        PyromelliticDianhydride = new Material.Builder(GTCEu.id("pyromellitic_dianhydride"))
                .dust()
                .components(GTMaterials.Carbon, 10, Hydrogen, 2, Oxygen, 6)
                .color(0x708090)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        CalciumCarbide = new Material.Builder(GTCEu.id("calcium_carbide"))
                .dust()
                .components(Calcium, 1, GTMaterials.Carbon, 2)
                .color(0x47443e)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Difluorobenzophenone = new Material.Builder(GTCEu.id("difluorobenzophenone"))
                .dust()
                .components(Fluorine, 2, GTMaterials.Carbon, 13, Hydrogen, 8, Oxygen, 1)
                .color(0xcf51ae)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Dichlorocyclooctadieneplatinum = new Material.Builder(
                ...
                .dust()
                .color(0xd4e982)
                .components(GTMaterials.Carbon, 8, Hydrogen, 12, Chlorine, 2, Platinum, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Diiodobiphenyl = new Material.Builder(GTCEu.id("diiodobiphenyl"))
                .dust()
                .color(0x000a42)
                .components(GTMaterials.Carbon, 12, Hydrogen, 8, Iodine, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Hexanitrohexaaxaisowurtzitane = new Material.Builder(
                ...
                .dust()
                .components(GTMaterials.Carbon, 6, Hydrogen, 6, Nitrogen, 12, Oxygen, 12)
                .color(0x3d464b)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Tetraacetyldinitrosohexaazaisowurtzitane = new Material.Builder(
                ...
                .dust()
                .color(0x500449)
                .components(GTMaterials.Carbon, 14, Hydrogen, 18, Nitrogen, 8, Oxygen, 6)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Dibenzyltetraacetylhexaazaisowurtzitane = new Material.Builder(
                ...
                .dust()
                .color(0x64704d)
                .components(GTMaterials.Carbon, 28, Hydrogen, 32, Nitrogen, 6, Oxygen, 4)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        SuccinamidylAcetate = new Material.Builder(GTCEu.id("succinimidyl_acetate"))
                .dust()
                .color(0x64704d)
                .components(GTMaterials.Carbon, 6, Hydrogen, 7, Nitrogen, 1, Oxygen, 4)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Hexabenzylhexaazaisowurtzitane = new Material.Builder(
                ...
                .dust()
                .color(0x64704d)
                .components(GTMaterials.Carbon, 48, Hydrogen, 48, Nitrogen, 6)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        NHydroxysuccinimide = new Material.Builder(GTCEu.id("n_hydroxysuccinimide"))
                .dust()
                .color(0x7b717f)
                .components(GTMaterials.Carbon, 4, Hydrogen, 5, Nitrogen, 1, Oxygen, 3)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        SuccinicAnhydride = new Material.Builder(GTCEu.id("succinic_anhydride"))
                .dust()
                .color(0x401116)
                .components(GTMaterials.Carbon, 4, Hydrogen, 4, Oxygen, 3)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        SuccinicAcid = new Material.Builder(GTCEu.id("succinic_acid"))
                .dust()
                .color(0x104e5c)
                .components(GTMaterials.Carbon, 4, Hydrogen, 6, Oxygen, 4)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Acetonitrile = new Material.Builder(GTCEu.id("acetonitrile"))
                .dust()
                .color(0x5a6161)
                .components(GTMaterials.Carbon, 2, Hydrogen, 3, Nitrogen, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Hexamethylenetetramine = new Material.Builder(GTCEu.id("hexamethylenetetramine"))
                .dust()
                .color(0x5a6261)
                .components(GTMaterials.Carbon, 6, Hydrogen, 12, Nitrogen, 4)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        PalladiumFullereneMatrix = new Material.Builder(GTCEu.id("palladium_fullerene_matrix"))
                .dust()
                .color(0x96b4b4)
                .components(Palladium, 1, GTMaterials.Carbon, 73, Hydrogen, 15, Nitrogen, 1, Iron, 1)
                .iconSet(BRIGHT)
                .buildAndRegister();
        ...
        UnfoldedFullerene = new Material.Builder(GTCEu.id("unfolded_fullerene"))
                .dust()
                .color(0x587f83)
                .components(GTMaterials.Carbon, 60, Hydrogen, 30)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Methylbenzophenanthrene = new Material.Builder(GTCEu.id("methylbenzophenanthrene"))
                .dust()
                .color(0x79260c)
                .components(GTMaterials.Carbon, 19, Hydrogen, 14)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Sarcosine = new Material.Builder(GTCEu.id("sarcosine"))
                .dust()
                .color(0x809324)
                .components(GTMaterials.Carbon, 3, Hydrogen, 7, Nitrogen, 1, Oxygen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        DiphenylmethaneDiisocyanate = new Material.Builder(
                ...
                .dust()
                .color(0x8e801c)
                .components(GTMaterials.Carbon, 15, Hydrogen, 10, Nitrogen, 2, Oxygen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Pentaerythritol = new Material.Builder(GTCEu.id("pentaerythritol"))
                .dust()
                .color(0xacacac)
                .components(GTMaterials.Carbon, 5, Hydrogen, 12, Oxygen, 4)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Ytterbium178 = new Material.Builder(GTCEu.id("ytterbium_178"))
                .fluid()
                .element(GTLCEuElements.YITTERBIUM178)
                .color(0xffffff)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Tannic = new Material.Builder(GTCEu.id("tannic"))
                .fluid()
                .components(GTMaterials.Carbon, 76, Hydrogen, 52, Oxygen, 46)
                .color(0xffff66)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Polyimide = new Material.Builder(GTCEu.id("polyimide"))
                .fluid()
                .components(GTMaterials.Carbon, 22, Hydrogen, 12, Nitrogen, 2, Oxygen, 6)
                .color(0xff6730)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Aniline = new Material.Builder(GTCEu.id("aniline"))
                .fluid()
                .components(GTMaterials.Carbon, 6, Hydrogen, 7, Nitrogen, 1)
                .color(0x3d7517)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Oxydianiline = new Material.Builder(GTCEu.id("oxydianiline"))
                .fluid()
                .components(GTMaterials.Carbon, 12, Hydrogen, 12, Nitrogen, 2, Oxygen, 1)
                .color(0xffd700)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        BenzenediazoniumTetrafluoroborate = new Material.Builder(
                ...
                .fluid()
                .components(GTMaterials.Carbon, 6, Hydrogen, 5, Boron, 1, Fluorine, 4, Nitrogen, 2)
                .color(0x8fbc8f)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        FluoroBenzene = new Material.Builder(GTCEu.id("fluoro_benzene"))
                .fluid()
                .components(GTMaterials.Carbon, 6, Hydrogen, 5, Fluorine, 1)
                .color(0x8fbc8f)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Fluorotoluene = new Material.Builder(GTCEu.id("fluorotoluene"))
                .fluid()
                .components(GTMaterials.Carbon, 7, Hydrogen, 7, Fluorine, 1)
                .color(0xdad386)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Hydroquinone = new Material.Builder(GTCEu.id("hydroquinone"))
                .fluid()
                .components(GTMaterials.Carbon, 6, Hydrogen, 6, Oxygen, 2)
                .color(0x8e2518)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Acetylene = new Material.Builder(GTCEu.id("acetylene"))
                .fluid()
                .components(GTMaterials.Carbon, 2, Hydrogen, 2)
                .color(0x7f8552)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        SodiumCyanide = new Material.Builder(GTCEu.id("sodium_cyanide"))
                .fluid()
                .components(Sodium, 1, GTMaterials.Carbon, 1, Nitrogen, 1)
                .color(0x4f6774)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        GoldCyanide = new Material.Builder(GTCEu.id("gold_cyanide"))
                .fluid()
                .components(Gold, 1, GTMaterials.Carbon, 1, Nitrogen, 1)
                .color(0x736f50)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        TrimethylTinChloride = new Material.Builder(GTCEu.id("trimethyltin_chloride"))
                .fluid()
                .color(0x72685f)
                .components(Tin, 1, GTMaterials.Carbon, 3, Hydrogen, 9, Chlorine, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        OneOctene = new Material.Builder(GTCEu.id("1_octene"))
                .fluid()
                .components(GTMaterials.Carbon, 8, Hydrogen, 16)
                .color(0x666d61)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Pyridine = new Material.Builder(GTCEu.id("pyridine"))
                .fluid()
                .color(0x555642)
                .components(GTMaterials.Carbon, 5, Hydrogen, 5, Nitrogen, 1)
                .iconSet(DULL)
                .buildAndRegister();

        Acetaldehyde = new Material.Builder(GTCEu.id("acetaldehyde"))
                .fluid()
                .components(GTMaterials.Carbon, 2, Hydrogen, 4, Oxygen, 1)
                .color(0x666d61)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Cyclooctadiene = new Material.Builder(GTCEu.id("cyclooctadiene"))
                .fluid()
                .color(0xd4e982)
                .components(GTMaterials.Carbon, 8, Hydrogen, 12)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Ethylenediamine = new Material.Builder(GTCEu.id("ethylenediamine"))
                .fluid()
                .color(0x1b5d74)
                .components(GTMaterials.Carbon, 2, Hydrogen, 8, Nitrogen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Ethanolamine = new Material.Builder(GTCEu.id("ethanolamine"))
                .fluid()
                .color(0x1b5d74)
                .components(GTMaterials.Carbon, 2, Hydrogen, 7, Nitrogen, 1, Oxygen, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Benzaldehyde = new Material.Builder(GTCEu.id("benzaldehyde"))
                .fluid()
                .color(0x905a1b)
                .components(GTMaterials.Carbon, 7, Hydrogen, 6, Oxygen, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        MaleicAnhydride = new Material.Builder(GTCEu.id("maleic_anhydride"))
                .fluid()
                .color(0x321b90)
                .components(GTMaterials.Carbon, 4, Hydrogen, 2, Oxygen, 3)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Benzylamine = new Material.Builder(GTCEu.id("benzylamine"))
                .fluid()
                .color(0x5b6363)
                .components(GTMaterials.Carbon, 7, Hydrogen, 9, Nitrogen, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Glyoxal = new Material.Builder(GTCEu.id("glyoxal"))
                .fluid()
                .color(0xf0ed4d)
                .components(GTMaterials.Carbon, 2, Hydrogen, 2, Oxygen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        BenzylChloride = new Material.Builder(GTCEu.id("benzyl_chloride"))
                .fluid()
                .color(0x9ff6fb)
                .components(GTMaterials.Carbon, 7, Hydrogen, 7, Chlorine, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        StearicAcid = new Material.Builder(GTCEu.id("stearic_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0x239791)
                .components(GTMaterials.Carbon, 18, Hydrogen, 36, Oxygen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Tricotylphosphine = new Material.Builder(GTCEu.id("tricotylphosphine"))
                .fluid()
                .color(0xe7d510)
                .components(GTMaterials.Carbon, 24, Hydrogen, 51, Phosphorus, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        FreeElectronGas = new Material.Builder(GTCEu.id("free_electron_gas"))
                .gas()
                .color(0x033c3c)
                .element(GTLCEuElements.ELECTRON)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        QuarkGluon = new Material.Builder(GTCEu.id("quark_gluon"))
                .plasma()
                .color(0x7a00da)
                .element(GTLCEuElements.QUARK_GLUON)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        HeavyQuarks = new Material.Builder(GTCEu.id("heavy_quarks"))
                .gas()
                .color(0x007000)
                .element(GTLCEuElements.HEAVY_QUARKS)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        LightQuarks = new Material.Builder(GTCEu.id("light_quarks"))
                .gas()
                .color(0x0000ce)
                .element(GTLCEuElements.LIGHT_QUARKS)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Titanium50 = new Material.Builder(GTCEu.id("titanium_50"))
                .ingot()
                .fluid()
                .element(GTLCEuElements.TITANIUM50)
                .blastTemp(1942)
                .color(0xd58eed)
                .iconSet(METALLIC)
                .buildAndRegister();
        ...
        Ferrocene = new Material.Builder(GTCEu.id("ferrocene"))
                .fluid()
                .color(0x7373c9)
                .components(GTMaterials.Carbon, 10, Hydrogen, 10, Iron, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        HeavyLeptonMixture = new Material.Builder(GTCEu.id("heavy_lepton_mixture"))
                .gas()
                .color(0x3ad931)
                .element(GTLCEuElements.HEAVY_LEPTON_MIXTURE)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        HeavyQuarkEnrichedMixture = new Material.Builder(
                ...
                .gas()
                .color(0xececec)
                .element(GTLCEuElements.HEAVY_QUARK_ENRICHED_MIXTURE)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        LiquidStarlight = new Material.Builder(GTCEu.id("liquid_starlight"))
                .liquid(new FluidBuilder().customStill())
                .element(GTLCEuElements.STARLIGHT)
                .buildAndRegister();
        ...
        DenseNeutron = new Material.Builder(GTCEu.id("dense_neutron"))
                .plasma()
                .color(0x9ce89c)
                .element(GTLCEuElements.DENSE_NEUTRON)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Isochloropropane = new Material.Builder(GTCEu.id("isochloropropane"))
                .fluid()
                .color(0xcdd681)
                .components(GTMaterials.Carbon, 3, Hydrogen, 7, Chlorine, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Dinitrodipropanyloxybenzene = new Material.Builder(
                ...
                .fluid()
                .color(0x6a784d)
                .components(GTMaterials.Carbon, 12, Hydrogen, 16, Nitrogen, 2, Oxygen, 6)
                .iconSet(DULL)
                .buildAndRegister();

        RadoxGas = new Material.Builder(GTCEu.id("radox_gas"))
                .gas()
                .components(GTMaterials.Carbon, 14, Osmium, 11, Silver, 3, Concrete, 1, Water, 1)
                .color(0xab57ab)
                .iconSet(BRIGHT)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        SuperLightRadox = new Material.Builder(GTCEu.id("superlightradox"))
                .fluid()
                .components(GTMaterials.Carbon, 14, Osmium, 11, Silver, 2, Concrete, 1, Water, 1)
                .color(0x6c006c)
                .iconSet(BRIGHT)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        LightRadox = new Material.Builder(GTCEu.id("lightradox"))
                .fluid()
                .components(GTMaterials.Carbon, 14, Osmium, 11, Silver, 1, Concrete, 1, Water, 1)
                .color(0x6c006c)
                .iconSet(BRIGHT)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        SuperHeavyRadox = new Material.Builder(GTCEu.id("superheavyradox"))
                .fluid()
                .components(GTMaterials.Carbon, 14, Osmium, 11, Concrete, 1, Water, 1)
                .color(0x6c006c)
                .iconSet(BRIGHT)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        Dibromomethylbenzene = new Material.Builder(GTCEu.id("dibromomethylbenzene"))
                .fluid()
                .components(GTMaterials.Carbon, 7, Hydrogen, 6, Bromine, 2)
                .color(0x6b584)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Phosgene = new Material.Builder(GTCEu.id("phosgene"))
                .fluid()
                .components(GTMaterials.Carbon, 1, Oxygen, 1, Chlorine, 2)
                .color(0x0e6c11)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        EthyleneGlycol = new Material.Builder(GTCEu.id("ethyleneglycol"))
                .fluid()
                .color(0xadadad)
                .components(GTMaterials.Carbon, 2, Hydrogen, 6, Oxygen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        PCBs = new Material.Builder(GTCEu.id("pcbs"))
                .fluid()
                .color(0x758a61)
                .components(GTMaterials.Carbon, 80, Hydrogen, 21, Oxygen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        DMAP = new Material.Builder(GTCEu.id("dmap"))
                .dust()
                .color(0x758a61)
                .components(GTMaterials.Carbon, 7, Hydrogen, 10, Nitrogen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        PhenylPentanoicAcid = new Material.Builder(GTCEu.id("phenylpentanoic_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0x4d3833)
                .components(GTMaterials.Carbon, 11, Hydrogen, 14, Oxygen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Dichloromethane = new Material.Builder(GTCEu.id("dichloromethane"))
                .fluid()
                .color(0x832663)
                .components(GTMaterials.Carbon, 1, Hydrogen, 2, Chlorine, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        DimethylSulfide = new Material.Builder(GTCEu.id("dimethyl_sulfide"))
                .fluid()
                .color(0xa02e06)
                .components(GTMaterials.Carbon, 2, Hydrogen, 6, Sulfur, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        CosmicMesh = new Material.Builder(GTCEu.id("cosmic_mesh"))
                ...
                .fluid()
                .color(0x181878)
                .element(GTLCEuElements.COSMIC_MESH)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        BenzophenanthrenylAcetonitrile = new Material.Builder(
                ...
                .dust()
                .components(GTMaterials.Carbon, 20, Hydrogen, 13, Nitrogen, 1)
                .color(0x9222c7)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        BromoSuccinamide = new Material.Builder(GTCEu.id("bromo_succinimide"))
                .dust()
                .components(GTMaterials.Carbon, 4, Hydrogen, 4, Bromine, 1, Nitrogen, 1, Oxygen, 2)
                .color(0x546a21)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Succinimide = new Material.Builder(GTCEu.id("succinimide"))
                .dust()
                .components(GTMaterials.Carbon, 4, Hydrogen, 5, Nitrogen, 1, Oxygen, 2)
                .color(0x21a7c5)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        AcrylicAcid = new Material.Builder(GTCEu.id("acrylic_acid"))
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0xb41558)
                .components(GTMaterials.Carbon, 3, Hydrogen, 4, Oxygen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        EthylAcrylate = new Material.Builder(GTCEu.id("ethyl_acrylate"))
                .fluid()
                .color(0x947d15)
                .components(GTMaterials.Carbon, 5, Hydrogen, 8, Oxygen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        BisethylenedithiotetraselenafulvalenePerrhenate = new Material.Builder(
                ...
                .dust()
                .color(0x72cb00)
                .components(Rhenium, 1, GTMaterials.Carbon, 10, Hydrogen, 8, Sulfur, 4, Selenium, 4, Oxygen, 4)
                .iconSet(BRIGHT)
                .buildAndRegister();
        ...
        Bisethylenedithiotetraselenafulvalene = new Material.Builder(
                ...
                .dust()
                .color(0x72cb00)
                .components(GTMaterials.Carbon, 10, Hydrogen, 8, Sulfur, 4, Selenium, 4)
                .iconSet(BRIGHT)
                .buildAndRegister();
        ...
        LithiumThiinediselenide = new Material.Builder(GTCEu.id("lithiumthiinediselenide"))
                .dust()
                .color(0x72cb00)
                .components(GTMaterials.Carbon, 4, Hydrogen, 4, Sulfur, 2, Lithium, 2, Selenium, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        CyclopentadienylTitaniumTrichloride = new Material.Builder(
                ...
                .dust()
                .color(0xb22db2)
                .components(GTMaterials.Carbon, 10, Hydrogen, 10, Chlorine, 2, Titanium, 1)
                .iconSet(BRIGHT)
                .buildAndRegister();
        ...
        ButylLithium = new Material.Builder(GTCEu.id("butyl_lithium"))
                .fluid()
                .color(0x9f6af6)
                .components(GTMaterials.Carbon, 4, Hydrogen, 9, Lithium, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Bromodihydrothiine = new Material.Builder(GTCEu.id("bromodihydrothiine"))
                .fluid()
                .color(0x50c44d)
                .components(GTMaterials.Carbon, 4, Hydrogen, 4, Sulfur, 2, Bromine, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Dibromoacrolein = new Material.Builder(GTCEu.id("dibromoacrolein"))
                .fluid()
                .color(0x3e3e3e)
                .components(GTMaterials.Carbon, 2, Hydrogen, 2, Bromine, 2, Oxygen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        HighPurityCalciumCarbonate = new Material.Builder(
                ...
                .dust()
                .color(0xeeeee0)
                .components(Calcium, 1, GTMaterials.Carbon, 1, Oxygen, 3)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Bromobutane = new Material.Builder(GTCEu.id("bromobutane"))
                .fluid()
                .color(0xff0c0c)
                .components(GTMaterials.Carbon, 4, Hydrogen, 9, Bromine, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Propadiene = new Material.Builder(GTCEu.id("propadiene"))
                .fluid()
                .color(0x323b0a)
                .components(GTMaterials.Carbon, 3, Hydrogen, 4)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        BoronFranciumCarbide = new Material.Builder(GTCEu.id("boron_francium_carbide"))
                .dust()
                .color(0x797979)
                .components(Francium, 4, Boron, 4, GTMaterials.Carbon, 7)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        FranciumCarbide = new Material.Builder(GTCEu.id("francium_carbide"))
                .dust()
                .color(0xa1a1a1)
                .components(Francium, 2, GTMaterials.Carbon, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        BoronCarbide = new Material.Builder(GTCEu.id("boron_carbide"))
                .dust()
                .color(0x1e1e1e)
                .components(Boron, 4, GTMaterials.Carbon, 3)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        CaliforniumCyclopentadienide = new Material.Builder(
                ...
                .fluid()
                .color(0x78374a)
                .components(GTMaterials.Carbon, 15, Hydrogen, 15, Californium, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Cyclopentadiene = new Material.Builder(GTCEu.id("cyclopentadiene"))
                .fluid()
                .color(0x2aa62a)
                .components(GTMaterials.Carbon, 5, Hydrogen, 6)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        LithiumCyclopentadienide = new Material.Builder(GTCEu.id("lithium_cyclopentadienide"))
                .fluid()
                .color(0x7b4657)
                .components(Lithium, 1, GTMaterials.Carbon, 5, Hydrogen, 5)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Dimethylether = new Material.Builder(GTCEu.id("dimethylether"))
                .fluid()
                .color(0xbda90e)
                .components(GTMaterials.Carbon, 2, Hydrogen, 6, Oxygen, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Dimethoxyethane = new Material.Builder(GTCEu.id("dimethoxyethane"))
                .fluid()
                .color(0x23a996)
                .components(GTMaterials.Carbon, 4, Hydrogen, 10, Oxygen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Photopolymer = new Material.Builder(GTCEu.id("photopolymer"))
                .fluid()
                .color(0x73445b)
                .components(GTMaterials.Carbon, 149, Hydrogen, 97, Nitrogen, 10, Oxygen, 2, Titanium, 1,
                        Boron, 1, Fluorine, 20)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        PhthalicAnhydride = new Material.Builder(GTCEu.id("phthalic_anhydride"))
                .dust()
                .color(0x8c8c8c)
                .components(GTMaterials.Carbon, 8, Hydrogen, 4, Oxygen, 3)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Ethylanthraquinone = new Material.Builder(GTCEu.id("ethylanthraquinone"))
                .fluid()
                .color(0xffff24)
                .components(GTMaterials.Carbon, 16, Hydrogen, 12, Oxygen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Phenylsodium = new Material.Builder(GTCEu.id("phenylsodium"))
                .fluid()
                .color(0x2626ab)
                .components(GTMaterials.Carbon, 6, Hydrogen, 5, Sodium, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        NDifluorophenylpyrrole = new Material.Builder(GTCEu.id("n_difluorophenylpyrrole"))
                .fluid()
                .color(0x2f7e8a)
                .components(GTMaterials.Carbon, 10, Hydrogen, 7, Fluorine, 2, Nitrogen, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Difluoroaniline = new Material.Builder(GTCEu.id("difluoroaniline"))
                .fluid()
                .color(0x348f3e)
                .components(GTMaterials.Carbon, 6, Hydrogen, 5, Fluorine, 2, Nitrogen, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Succinaldehyde = new Material.Builder(GTCEu.id("succinaldehyde"))
                .fluid()
                .color(0x63577d)
                .components(GTMaterials.Carbon, 4, Hydrogen, 6, Oxygen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        TetraethylammoniumBromide = new Material.Builder(GTCEu.id("tetraethylammonium_bromide"))
                .fluid()
                .color(0xc20cff)
                .components(GTMaterials.Carbon, 8, Hydrogen, 20, Nitrogen, 1, Bromine, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Dimethylnaphthalene = new Material.Builder(GTCEu.id("dimethylnaphthalene"))
                .fluid()
                .color(0xde2da1)
                .components(GTMaterials.Carbon, 12, Hydrogen, 12)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Dihydroiodotetracene = new Material.Builder(GTCEu.id("dihydroiodotetracene"))
                .fluid()
                .color(0xde2da1)
                .components(GTMaterials.Carbon, 18, Hydrogen, 13, Iodine, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        AcetylatingReagent = new Material.Builder(GTCEu.id("acetylating_reagent"))
                .fluid()
                .color(0x724c50)
                .components(GTMaterials.Carbon, 9, Hydrogen, 12, Silicon, 1, Magnesium, 2, Bromine, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        IsopropylAlcohol = new Material.Builder(GTCEu.id("isopropyl_alcohol"))
                .fluid()
                .color(0x51b31f)
                .components(GTMaterials.Carbon, 3, Hydrogen, 8, Oxygen, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Dichlorodicyanobenzoquinone = new Material.Builder(
                ...
                .fluid()
                .color(0x302399)
                .components(GTMaterials.Carbon, 8, Chlorine, 2, Nitrogen, 2, Oxygen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Dichlorodicyanohydroquinone = new Material.Builder(
                ...
                .fluid()
                .color(0x302399)
                .components(GTMaterials.Carbon, 8, Chlorine, 2, Nitrogen, 2, Oxygen, 2, Hydrogen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Tetracene = new Material.Builder(GTCEu.id("tetracene"))
                .dust()
                .color(0x8f7718)
                .components(GTMaterials.Carbon, 18, Hydrogen, 12)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        RheniumHassiumThalliumIsophtaloylbisdiethylthioureaHexaf = new Material.Builder(
                ...
                .dust()
                .color(0x8f7718)
                .components(Rhenium, 1, Hassium, 1, Thallium, 1, GTMaterials.Carbon, 60, Phosphorus, 1,
        ...
        IsophthaloylBis = new Material.Builder(GTCEu.id("isophthaloylbis"))
                .fluid()
                .color(0x76677e)
                .components(GTMaterials.Carbon, 18, Hydrogen, 26, Nitrogen, 4, Oxygen, 2, Sulfur, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Diethylthiourea = new Material.Builder(GTCEu.id("diethylthiourea"))
                .fluid()
                .color(0x23a687)
                .components(GTMaterials.Carbon, 5, Hydrogen, 12, Nitrogen, 2, Sulfur, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        PhenylenedioxydiaceticAcid = new Material.Builder(
                ...
                .liquid(new FluidBuilder().attribute(FluidAttributes.ACID))
                .color(0x7c4456)
                .components(GTMaterials.Carbon, 10, Hydrogen, 10, Oxygen, 6)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        SodiumThiocyanate = new Material.Builder(GTCEu.id("sodium_thiocyanate"))
                .fluid()
                .color(0x7c4456)
                .components(Sodium, 1, Sulfur, 1, GTMaterials.Carbon, 1, Nitrogen, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Ethylamine = new Material.Builder(GTCEu.id("ethylamine"))
                .fluid()
                .color(0x5a656d)
                .components(GTMaterials.Carbon, 2, Hydrogen, 5, Nitrogen, 1, Hydrogen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        TolueneDiisocyanate = new Material.Builder(GTCEu.id("toluene_diisocyanate"))
                .fluid()
                .color(0xacf4bf)
                .components(GTMaterials.Carbon, 9, Hydrogen, 6, Nitrogen, 2, Oxygen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Polyurethane = new Material.Builder(GTCEu.id("polyurethane"))
                .fluid()
                .color(0xacf4bf)
                .components(GTMaterials.Carbon, 17, Hydrogen, 16, Nitrogen, 2, Oxygen, 4)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Glucose = new Material.Builder(GTCEu.id("glucose"))
                .dust()
                .color(0xcacace)
                .components(GTMaterials.Carbon, 6, Hydrogen, 12, Oxygen, 6)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        GrapheneOxide = new Material.Builder(GTCEu.id("graphene_oxide"))
                .dust()
                .color(0x535353)
                .components(GTMaterials.Carbon, 1, Oxygen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Kerosene = new Material.Builder(GTCEu.id("kerosene"))
                .fluid()
                .components(GTMaterials.Carbon, 12, Hydrogen, 24)
                .color(0xce57ce)
                .iconSet(DULL)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        Monomethylhydrazine = new Material.Builder(GTCEu.id("monomethylhydrazine"))
                .fluid()
                .color(0xffffff)
                .components(GTMaterials.Carbon, 1, Hydrogen, 6, Nitrogen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        SodiumEthylate = new Material.Builder(GTCEu.id("sodium_ethylate"))
                .dust()
                .color(0x9bcd9b)
                .components(GTMaterials.Carbon, 2, Hydrogen, 5, Oxygen, 1, Sodium, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        SodiumEthylxanthate = new Material.Builder(GTCEu.id("sodium_ethylxanthate"))
                .dust()
                .color(0xcdad00)
                .components(GTMaterials.Carbon, 3, Hydrogen, 5, Sodium, 1, Oxygen, 1, Sulfur, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        PotassiumEthylxanthate = new Material.Builder(GTCEu.id("potassium_ethylxanthate"))
                .dust()
                .color(0xcdc8b1)
                .components(GTMaterials.Carbon, 3, Hydrogen, 5, Potassium, 1, Oxygen, 1, Sulfur, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        PotassiumEthylate = new Material.Builder(GTCEu.id("potassium_ethylate"))
                .dust()
                .color(0xcd661d)
                .components(GTMaterials.Carbon, 2, Hydrogen, 5, Oxygen, 1, Potassium, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        NMPyrolidone = new Material.Builder(GTCEu.id("nmethylpyrolidone"))
                .fluid()
                .color(0xd0d0d0)
                .components(GTMaterials.Carbon, 5, Hydrogen, 9, Nitrogen, 1, Oxygen, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Methylamine = new Material.Builder(GTCEu.id("methylamine"))
                .fluid()
                .color(0x45486f)
                .components(GTMaterials.Carbon, 1, Hydrogen, 5, Nitrogen, 1)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        PPhenylenediamine = new Material.Builder(GTCEu.id("p_phenylenediamine"))
                .dust()
                .color(0xdccf52)
                .components(GTMaterials.Carbon, 6, Hydrogen, 8, Nitrogen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        TerephthalicAcid = new Material.Builder(GTCEu.id("terephthalicacid"))
                .fluid()
                .color(0xd6d6d6)
                .components(GTMaterials.Carbon, 8, Hydrogen, 6, Hydrogen, 4)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        DimethylTerephthalate = new Material.Builder(GTCEu.id("dimethylterephthalate"))
                .fluid()
                .color(0xd1d1d1)
                .components(GTMaterials.Carbon, 10, Hydrogen, 10, Hydrogen, 4)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        TerephthaloylChloride = new Material.Builder(GTCEu.id("terephthaloyl_chloride"))
                .dust()
                .color(0x00e60b)
                .components(GTMaterials.Carbon, 8, Hydrogen, 4, Chlorine, 2, Nitrogen, 2)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Rhugnor = new Material.Builder(GTCEu.id("rhugnor"))
                .fluid()
                .color(0xa800e2)
                .element(GTLCEuElements.RHUGNOR)
                .iconSet(METALLIC)
                .buildAndRegister();
        ...
        Copper76 = new Material.Builder(GTCEu.id("copper76"))
                .dust()
                .element(GTLCEuElements.COPPER76)
                .color(0xe77c56)
                .iconSet(BRIGHT)
                .buildAndRegister();
        ...
        Paa = new Material.Builder(GTCEu.id("paa"))
                .fluid()
                .components(GTMaterials.Carbon, 22, Hydrogen, 14, Nitrogen, 2, Oxygen, 7)
                .color(0xead05e)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Turpentine = new Material.Builder(GTCEu.id("turpentine"))
                .fluid()
                .components(GTMaterials.Carbon, 10, Hydrogen, 16)
                .color(0x9acd32)
                .flags(DISABLE_DECOMPOSITION)
                .iconSet(FLUID)
                .buildAndRegister();
        ...
        LeachedTurpentine = new Material.Builder(GTCEu.id("leached_turpentine"))
                .fluid()
                .components(GTMaterials.Carbon, 10, Hydrogen, 16, Concrete, 1)
                .color(0xcd9b1d)
                .flags(DISABLE_DECOMPOSITION)
                .iconSet(FLUID)
                .buildAndRegister();
        ...
        RedstoneFront = new Material.Builder(GTCEu.id("redstone_front"))
                .fluid()
                .components(GTMaterials.Redstone, 1)
                .color(0xee0000)
                .flags(DISABLE_DECOMPOSITION)
                .iconSet(FLUID)
                .buildAndRegister();
        ...
        CarbonDisulfide = new Material.Builder(GTCEu.id("carbon_disulfide"))
                .fluid()
                .components(GTMaterials.Carbon, 1, Sulfur, 2)
                .color(0x104e8b)
                .flags(DISABLE_DECOMPOSITION)
                .iconSet(FLUID)
                .buildAndRegister();
        ...
        HydroiodicAcid = new Material.Builder(GTCEu.id("hydroiodic_acid"))
                ...
                .color(0x0382e2)
                .iconSet(GTLCEuMaterialIconSet.LIMPID)
                .buildAndRegister();

        Acrylonitrile = new Material.Builder(GTCEu.id("acrylonitrile"))
                .fluid()
                .components(GTMaterials.Carbon, 3, Hydrogen, 3, Nitrogen, 1)
                .color(0xa4a4e1)
                .iconSet(GTLCEuMaterialIconSet.LIMPID)
                .buildAndRegister();
        ...
        TertButanol = new Material.Builder(GTCEu.id("tert_butanol"))
                .fluid()
                .components(GTMaterials.Carbon, 4, Hydrogen, 10, Oxygen, 1)
                .color(0xacb500)
                .iconSet(GTLCEuMaterialIconSet.LIMPID)
                .buildAndRegister();
        ...
        DitertbutylDicarbonate = new Material.Builder(GTCEu.id("ditertbutyl_dicarbonate"))
                .dust()
                .components(GTMaterials.Carbon, 10, Hydrogen, 18, Oxygen, 5)
                .color(0x7e96b5)
                .iconSet(DULL)
                .buildAndRegister();
        ...
        Tertbuthylcarbonylazide = new Material.Builder(GTCEu.id("tertbuthylcarbonylazide"))
                .fluid()
                .components(GTMaterials.Carbon, 5, Hydrogen, 9, Nitrogen, 3, Oxygen, 2)
                .color(0xacb500)
                .iconSet(GTLCEuMaterialIconSet.LIMPID)
                .buildAndRegister();
        ...
        SodiumToluenesulfonate = new Material.Builder(GTCEu.id("sodium_toluenesulfonate"))
                .fluid()
                .components(GTMaterials.Carbon, 7, Hydrogen, 7, Sulfur, 3, Oxygen, 3, Sodium, 1)
                .color(0xb5b41d)
                .iconSet(GTLCEuMaterialIconSet.LIMPID)
                .buildAndRegister();
        ...
        AminatedFullerene = new Material.Builder(GTCEu.id("aminated_fullerene"))
                .fluid()
                .components(GTMaterials.Carbon, 60, Hydrogen, 12, Nitrogen, 12)
                .color(0x3842f0)
                .iconSet(GTLCEuMaterialIconSet.LIMPID)
                .buildAndRegister();
        ...
        SodiumFormate = new Material.Builder(GTCEu.id("sodium_formate"))
                ...
                .components(Sodium, 1, GTMaterials.Carbon, 1, Oxygen, 2, Hydrogen, 1)
                .buildAndRegister();
        ...
        SpaceTime = new Material.Builder(GTCEu.id("spacetime"))
                ...
                .element(GTLCEuElements.SPACETIME)
                .iconSet(new MaterialIconSet("spacetime"))
                .flags(GTLCEuMaterialFlags.GENERATE_NANOSWARM, NO_UNIFICATION)
        ...
        Infinity = new Material.Builder(GTCEu.id("infinity"))
                ...
                .element(GTLCEuElements.INFINITY)
        ...
        Fluorocarborane = new Material.Builder(GTCEu.id("fluorocarborane"))
                .dust()
                .components(Hydrogen, 1, GTMaterials.Carbon, 1, Hydrogen, 1, Boron, 11, Fluorine, 11)
        ...
        CesiumCarborane = new Material.Builder(GTCEu.id("cesium_carborane"))
                .dust()
                .components(Caesium, 1, GTMaterials.Carbon, 1, Boron, 11, Hydrogen, 12)
        ...
        TrifluoroaceticPhosphateEster = new Material.Builder(GTCEu.id("trifluoroacetic_phosphate_ester"))
                .dust()
                .components(GTMaterials.Carbon, 8, Hydrogen, 5, Fluorine, 3, Oxygen, 2, Sulfur, 1)
        ...
        FumingNitricAcid = new Material.Builder(GTCEu.id("fuming_nitric_acid"))
                .fluid()
                .components(Hydrogen, 1, Nitrogen, 1, Oxygen, 3)
                .color(0xB46800).iconSet(GTLCEuMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();

        Perfluorobenzene = new Material.Builder(GTCEu.id("perfluorobenzene"))
                .fluid()
                .components(GTMaterials.Carbon, 6, Fluorine, 6)
                .color(0x15752B).iconSet(GTLCEuMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();

        Trimethylsilane = new Material.Builder(GTCEu.id("trimethylsilane"))
                .fluid()
                .components(GTMaterials.Carbon, 3, Hydrogen, 10, Silicon, 1)
                .color(0x7D2FC3).iconSet(GTLCEuMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();

        Trimethylchlorosilane = new Material.Builder(GTCEu.id("trimethylchlorosilane"))
                .fluid()
                .color(0x591399).iconSet(GTLCEuMaterialIconSet.LIMPID)
        ...
        NitratedTriniiteCompoundSolution = new Material.Builder(GTCEu.id("nitrated_triniite_compound_solution"))
                .fluid()
                .color(0x5E9699).iconSet(GTLCEuMaterialIconSet.LIMPID)
                .buildAndRegister();

        ResidualTriniiteSolution = new Material.Builder(GTCEu.id("residual_triniite_solution"))
                .fluid()
                .color(0x68B59).iconSet(GTLCEuMaterialIconSet.LIMPID)
                .buildAndRegister();

        ActiniumRadiumHydroxideSolution = new Material.Builder(GTCEu.id("actinium_radium_hydroxide_solution"))
                .fluid()
                .color(0xC3E0DC).iconSet(GTLCEuMaterialIconSet.LIMPID)
                .buildAndRegister();

        ActiniumRadiumNitrateSolution = new Material.Builder(GTCEu.id("actinium_radium_nitrate_solution"))
                .fluid()
                .color(0x89C0B3).iconSet(GTLCEuMaterialIconSet.LIMPID)
                .buildAndRegister();

        HeavilyFluorinatedTriniumSolution = new Material.Builder(GTCEu.id("heavily_fluorinated_trinium_solution"))
                .fluid()
                .color(0x169A33).iconSet(GTLCEuMaterialIconSet.LIMPID)
                .buildAndRegister();

        EthyleneSulfide = new Material.Builder(GTCEu.id("ethylene_sulfide"))
                .fluid()
                .components(GTMaterials.Carbon, 6, Hydrogen, 6, Sulfur, 1, Oxygen, 1)
                .color(0x868544).iconSet(GTLCEuMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();

        EthylTrifluoroacetate = new Material.Builder(GTCEu.id("ethyl_trifluoroacetate"))
                .fluid()
                .components(GTMaterials.Carbon, 4, Hydrogen, 5, Fluorine, 3, Oxygen, 2)
                .color(0x93A658).iconSet(GTLCEuMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();

        AcetylChloride = new Material.Builder(GTCEu.id("acetyl_chloride"))
                .fluid()
                .components(GTMaterials.Carbon, 2, Hydrogen, 3, Oxygen, 1, Chlorine, 1)
                .color(0xD1B117).iconSet(GTLCEuMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        KryptonDifluoride = new Material.Builder(GTCEu.id("krypton_difluoride"))
                ...
                .color(0x3FF12B).iconSet(GTLCEuMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        Trimethylamine = new Material.Builder(GTCEu.id("trimethylamine"))
                .fluid()
                .color(0xCEA67D).iconSet(GTLCEuMaterialIconSet.LIMPID)
        ...
        SodiumHexafluoroaluminate = new Material.Builder(GTCEu.id("sodium_hexafluoroaluminate"))
                ...
                .color(0xA47732).iconSet(GTLCEuMaterialIconSet.LIMPID)
                .buildAndRegister();

        DirtyHexafluorosilicicAcid = new Material.Builder(GTCEu.id("dirty_hexafluorosilicic_acid"))
                .fluid()
                .color(0xDA387D).iconSet(GTLCEuMaterialIconSet.LIMPID)
        ...
        DiluteHexafluorosilicicAcid = new Material.Builder(GTCEu.id("dilute_hexafluorosilicic_acid"))
                .fluid()
                .color(0x49DF68).iconSet(GTLCEuMaterialIconSet.LIMPID)
        ...
        TritiumHydride = new Material.Builder(GTCEu.id("tritium_hydride"))
                ...
                .color(0xBA0202).iconSet(GTLCEuMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        DustyLiquidHeliumIII = new Material.Builder(GTCEu.id("dusty_liquid_helium_iii"))
                ...
                .color(0x774060).iconSet(GTLCEuMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        Ozone = new Material.Builder(GTCEu.id("ozone"))
                .fluid()
                .components(Oxygen, 3)
                .color(0x0176C4).iconSet(GTLCEuMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        RareEarthChlorides = new Material.Builder(GTCEu.id("rare_earth_chlorides"))
                ...
                .color(0xBDB76B).iconSet(GTLCEuMaterialIconSet.LIMPID)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        ...
        OxalicAcid = new Material.Builder(GTCEu.id("oxalic_acid"))
                .fluid()
                .components(GTMaterials.Carbon, 2, Hydrogen, 2, Oxygen, 4)
                .color(0xA0FFA0)
                .iconSet(GTLCEuMaterialIconSet.LIMPID)
                .buildAndRegister();
        ...
        CeriumOxalatePowder = new Material.Builder(GTCEu.id("cerium_oxalate_powder"))
                .dust()
                .components(Cerium, 1, GTMaterials.Carbon, 2, Hydrogen, 2, Oxygen, 4)
                .color(0x969696)
                .flags(DISABLE_DECOMPOSITION)
                .iconSet(SAND)
                .buildAndRegister();
        ...
        SamariumOxalateWithImpurities = new Material.Builder(GTCEu.id("samarium_oxalate_with_impurities"))
                .dust()
                .components(Samarium, 1, GTMaterials.Carbon, 2, Oxygen, 6)
                .color(0x808080)
                .iconSet(SAND)
                .buildAndRegister();
        ...
        FluoroCarbonLanthanideCeriumOxidePowder = new Material.Builder(GTCEu.id("fluoro_carbon_lanthanide_cerium_oxide_powder"))
                .dust()
                .color(0x7F7F7F)
                .iconSet(GTLCEuMaterialIconSet.BRIGHT)
                .buildAndRegister();
        ...
        CarbonTetrachloride = new Material.Builder(GTCEu.id("carbon_tetrachloride"))
                .fluid()
                .color(0x0E9000)
                .components(GTMaterials.Carbon, 1, Chlorine, 4)
                .iconSet(GTLCEuMaterialIconSet.LIMPID)
                .buildAndRegister();
