...
public class TootipsModify {
    ...
    public static void init() {
        ...
        hpca_computation_component.setTooltipBuilder(hpca_computation_component.getTooltipBuilder().andThen(GTLCEuMachines.GTL_MODIFY));
        ...
        hpca_advanced_computation_component.setTooltipBuilder(hpca_advanced_computation_component.getTooltipBuilder().andThen(GTLCEuMachines.GTL_MODIFY));
        ...
        //}));
        //electric_blast_furnace.setTooltipBuilder(electric_blast_furnace.getTooltipBuilder().andThen(GTLCEuMachines.GTL_MODIFY));

        MachineDefinition steamExportBus = GTMachines.STEAM_EXPORT_BUS;
        steamExportBus.setTooltipBuilder(steamExportBus.getTooltipBuilder().andThen(GTLCEuMachines.GTL_MODIFY));
        MachineDefinition steamImportBus = GTMachines.STEAM_IMPORT_BUS;
        steamImportBus.setTooltipBuilder(steamImportBus.getTooltipBuilder().andThen(GTLCEuMachines.GTL_MODIFY));

        //MachineDefinition steamOven = GTMachines.STEAM_OVEN;
        //steamOven.setTooltipBuilder(steamOven.getTooltipBuilder().andThen(GTLCEuMachines.GTL_MODIFY));
    }
}
