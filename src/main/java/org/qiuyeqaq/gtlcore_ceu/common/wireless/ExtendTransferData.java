    ...
    public Component getInfo() {
        ...
        if (eut > 0) {
            return Component.translatable(machine.getBlockState().getBlock().getDescriptionId())
                    ...
                    .append(Component.translatable("gtlcore_ceu.machine.energy_loss", Component.literal(FormattingUtil.formatNumbers(loss())).append(" EU/t (").append(GTValues.VNF[GTUtil.getFloorTierByVoltage(loss())]).append(")")))
