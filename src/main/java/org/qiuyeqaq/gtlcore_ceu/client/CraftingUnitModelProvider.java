...
import static org.qiuyeqaq.gtlcore_ceu.common.block.CraftingUnitType.*;
...
public class CraftingUnitModelProvider extends AbstractCraftingUnitModelProvider<CraftingUnitType> {
    ...
    private static Material texture(String name) {
        var material = new Material(InventoryMenu.BLOCK_ATLAS, GTLCore_CEu.id("block/crafting/" + name));
