...
import org.qiuyeqaq.gtlcore_ceu.client.ClientUtil;
import org.qiuyeqaq.gtlcore_ceu.common.machine.multiblock.electric.HarmonyMachine;
...
public class EyeOfHarmonyRenderer extends WorkableCasingMachineRenderer implements IControllerRenderer {
    ...
    private static final ResourceLocation SPACE_MODEL = GTLCore_CEu.id("obj/space");
    public static final ResourceLocation STAR_MODEL = GTLCore_CEu.id("obj/star");
    private static final List<ResourceLocation> ORBIT_OBJECTS = List.of(
            GTLCore_CEu.id("obj/the_nether"),
            GTLCore_CEu.id("obj/overworld"),
            GTLCore_CEu.id("obj/the_end"));

    public EyeOfHarmonyRenderer() {
        super(GTLCore_CEu.id("block/casings/dimensionally_transcendent_casing"), GTCEu.id("block/multiblock/cosmos_simulation"));
    }
