...
public class AEDualConfigSlotWidget extends Widget implements IGhostItemTarget, IGhostFluidTarget {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        if (mouseOverConfig(mouseX, mouseY)) {
            ...
            if (button == 1) {
                ...
                net.minecraftforge.fluids.FluidStack fluidStack = FluidUtil.getFluidContained(hold).orElse(net.minecraftforge.fluids.FluidStack.EMPTY);
                if (fluidStack != net.minecraftforge.fluids.FluidStack.EMPTY) {
    ...
    public void readUpdateInfo(int id, FriendlyByteBuf buffer) {
        ...
        if (id == FLUID_UPDATE_ID) {
            net.minecraftforge.fluids.FluidStack fluid = new net.minecraftforge.fluids.FluidStack(BuiltInRegistries.FLUID.get(buffer.readResourceLocation()), buffer.readVarInt());
    ...
    public List<Target> getPhantomTargets(Object ingredient) {
        ...
        if (result instanceof ItemStack) {
        ...
        } else if (result instanceof net.minecraftforge.fluids.FluidStack && drainFrom(ingredient) != null) {
            return Lists.newArrayList(new Target[] { new Target() {
                ...
                public void accept(@NotNull Object ingredient) {
                    ...
                    net.minecraftforge.fluids.FluidStack ingredientStack;
