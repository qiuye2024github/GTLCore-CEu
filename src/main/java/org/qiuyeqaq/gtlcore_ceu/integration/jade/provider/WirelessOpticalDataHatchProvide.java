...
public class WirelessOpticalDataHatchProvide extends CapabilityBlockProvider<BindCapability> {
    ...
    protected void addTooltip(CompoundTag capData, ITooltip tooltip, Player player, BlockAccessor block, BlockEntity blockEntity, IPluginConfig config) {
         ...
         * tooltip.add(Component.translatable("gtceu.machine.wireless_data_transmitter_hatch.bind",
         * capData.getString("pos")));
         * } else {
         * tooltip.add(Component.translatable("gtceu.machine.wireless_data_receiver_hatch.bind",
         * capData.getString("pos")));
         * }
         * } else {
         * if (wod.isTransmitter()) {
